...
export const defaultCategories = [
  { id:1, path: "/1", name: "2D Asset", parent: null, menu: "Home"},
  { id:2, path: "/1/2", name: "FX", parent: "2D Asset", menu: "Home"},
  { id:3, path: "/3", name: "3D Asset", parent: null, menu: "Home" },
  { id:4, path: "/3/4", name: "Accessories", parent: "3D Asset", menu: "Home" },
  { id:5, path: "/3/5", name: "Animal", parent: "3D Asset", menu: "Home" },
  { id:6, path: "/3/5/6", name: "Fish", parent: "Animal", menu: "Home" },
  { id:7, path: "/3/7", name: "Building", parent: "3D Asset", menu: "Home" },
  { id:8, path: "/3/8", name: "Char", parent: "3D Asset", menu: "Home" },
  { id:9, path: "/3/8/9", name: "Male", parent: "Char", menu: "Home" },
  { id:10, path: "/3/8/10", name:"Female", parent: "Char", menu: "Home" },
  { id:11, path: "/3/8/11", name: "Parts", parent: "Char", menu: "Home" },
  { id:12, path: "/3/12", name: "Indoor", parent: "3D Asset", menu: "Home" },
  { id:13, path: "/3/13", name: "Exterior", parent: "3D Asset", menu: "Home" },
  { id:14, path: "/3/14", name: "Naturel", parent: "3D Asset", menu: "Home" },
  { id:15, path: "/3/14/15", name: "Rocks", parent: "Naturel", menu: "Home" },
  { id:16, path: "/3/16", name: "Scene", parent: "3D Asset", menu: "Home" },
  { id:17, path: "/3/17", name: "Product", parent: "3D Asset", menu: "Home" },
  { id:18, path: "/3/18", name: "Weapon", parent: "3D Asset", menu: "Home" },
