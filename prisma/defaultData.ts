...
export const defaultCategories = [
  ...
  { id: 19, path: "/5", name: "3D Plants", parent: null, menu: "Home" },
  { id: 20, path: "/5/20", name: "Bushes", parent: "3D Plants", menu: "Home" },
  { id: 21, path: "/5/21", name: "Flower", parent: "3D Plants", menu: "Home" },
  { id: 22, path: "/5/22", name: "Grass", parent: "3D Plants", menu: "Home" },
  { id: 23, path: "/5/23", name: "Tree", parent: "3D Plants", menu: "Home" },
  { id: 24, path: "/6", name: "Surfaces", parent: null, menu: "Home" },
  { id: 25, path: "/6/25", name: "Brick", parent: "Surfaces", menu: "Home" },
  { id: 26, path: "/6/26", name: "Concrete", parent: "Surfaces", menu: "Home" },
  { id: 27, path: "/6/27", name: "Fabric", parent: "Surfaces", menu: "Home" },
  { id: 28, path: "/6/28", name: "Ground", parent: "Surfaces", menu: "Home" },
  { id: 29, path: "/6/29", name: "Lawn", parent: "Surfaces", menu: "Home" },
  { id: 30, path: "/6/30", name: "Marble", parent: "Surfaces", menu: "Home" },
  { id: 31, path: "/6/31", name: "Metal", parent: "Surfaces", menu: "Home" },
  { id: 32, path: "/6/32", name: "Rock", parent: "Surfaces", menu: "Home" },
  { id: 33, path: "/6/33", name: "Roofing", parent: "Surfaces", menu: "Home" },
  { id: 34, path: "/6/34", name: "Sand", parent: "Surfaces", menu: "Home" },
  { id: 35, path: "/6/35", name: "Snow", parent: "Surfaces", menu: "Home" },
  { id: 36, path: "/6/36", name: "Soil", parent: "Surfaces", menu: "Home" },
  { id: 37, path: "/6/37", name: "Stone", parent: "Surfaces", menu: "Home" },
  { id: 38, path: "/6/38", name: "Tile", parent: "Surfaces", menu: "Home" },
  { id: 39, path: "/6/39", name: "Wood", parent: "Surfaces", menu: "Home" },
  { id: 40, path: "/6/40", name: "Other", parent: "Surfaces", menu: "Home" },
  { id: 41, path: "/6/41", name: "Other", parent: "Surfaces", menu: "Home" },
];
